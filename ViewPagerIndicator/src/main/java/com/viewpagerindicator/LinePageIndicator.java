...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultLineHeight = res.getDimension(R.dimen
                .default_line_indicator_line_height);
        final float defaultGapWidth = res.getDimension(R.dimen.default_line_indicator_line_width);
        ...
        mLineHeight = a.getDimension(R.styleable.LinePageIndicator_lineHight, defaultLineHeight);
        mGapWidth = a.getDimension(R.styleable.LinePageIndicator_gapWidth, defaultGapWidth);
        setStrokeWidth(a.getDimension(R.styleable.LinePageIndicator_strokeWidth,
                defaultStrokeWidth));
        mPaintUnselected.setColor(a.getColor(R.styleable.LinePageIndicator_unselectedColor,
                defaultUnselectedColor));
        mPaintSelected.setColor(a.getColor(R.styleable.LinePageIndicator_selectedColor,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawRect(dx1, verticalOffset, dx2, mLineHeight, (i == mCurrentPage) ?
                    mPaintSelected : mPaintUnselected);
            /*canvas.drawLine(dx1, verticalOffset, dx2, verticalOffset, (i == mCurrentPage) ?
                    mPaintSelected : mPaintUnselected);*/
        }
    }
